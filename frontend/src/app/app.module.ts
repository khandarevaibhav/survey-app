...
// import {CdkDragDropVerticalSortingExample} from './app/
...
@NgModule({
  declarations: [
    ...
    ParentTestComponentComponent,
    ChildTestComponentComponent,
  ],

  // entryComponents: [CdkDragDropVerticalSortingExample],
  // declarations: [CdkDragDropVerticalSortingExample],
