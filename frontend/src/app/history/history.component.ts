...
export class HistoryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.httpClient
      .get("http://localhost:5000/form", { headers: headers1 })
      .subscribe((response) => {
  ...
  deleteSurvey(survey_id: any) {
    ...
    this.httpClient
      .delete(`http://localhost:5000/form/${survey_id}`, { headers: headers1 })
      .subscribe((response) => {
        console.log(response);
  ...
  downloadSurvey(survey_id: any){
    ...
    // });
    this.httpClient
      .get(`http://localhost:5000/response/downloadcsv/${survey_id}`)
      .subscribe((response) => {
        console.log(response);
        this.data = response;
      });
